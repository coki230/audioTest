...
# words = [f.name for f in data_dir.iterdir() if f.is_dir()]
...
#     # print('Waveform dtype:', waveform.numpy().dtype())
#     print('Waveform min:', waveform.numpy().min(),'Waveform max:', waveform.numpy().max())
#     print('Spectrogram shape:', spectrogram.shape)
#     print('Audio playback')
#     sd.play(waveform.numpy(), samplerate=16000)
#     sd.wait()
#
